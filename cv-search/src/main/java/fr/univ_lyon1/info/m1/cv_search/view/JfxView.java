    ...
    private Node createStrategySelector() {
        ...
        strategyComboBox.getItems().add(new Strategy() {
            ...
            public boolean select(Applicant a, List<String> skills) {
                for (String s : skills) {
                    if (a.getSkill(s) < 50) return false;
                }
                return true;
            }

            @Override
            public String toString() { return "All >= 50%"; }
        });
        ...
        strategyComboBox.getItems().add(new Strategy() {
            ...
            public boolean select(Applicant a, List<String> skills) {
                for (String s : skills) {
                    if (a.getSkill(s) < 60) return false;
                }
                return true;
            }

            @Override
            public String toString() { return "All >= 60%"; }
        });
        ...
        strategyComboBox.getItems().add(new Strategy() {
            ...
            @Override
            public String toString() { return "Average >= 50%"; }
        });
